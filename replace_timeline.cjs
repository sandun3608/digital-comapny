...
const filepath = 'services/mobile-app.html';
...
// Replace <section style="padding: 5rem 10% 4rem; background: var(--bg-secondary);"> ... </section>
const regex = /<section style="padding: 5rem 10% 4rem; background: var\(--bg-secondary\);">[\s\S]*?<\/section>/g;
